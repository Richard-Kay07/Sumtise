...
export default function BillingPaymentsPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHeader crumbs={[{ label: "Accounting", href: "/accounting" }]} title="Billing & Payments" />

      <main className="max-w-5xl mx-auto px-4 py-8">
        <div className="mb-6">
          <h2 className="text-xl font-bold tracking-tight" style={{ color: DARK }}>Billing &amp; Payments</h2>
          <p className="text-sm text-gray-500 mt-1">Recurring invoices and supplier payment runs</p>
        </div>
