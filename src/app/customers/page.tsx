...
const TILES = [
  { href: "/customers/all", icon: Users,    label: "All Customers", desc: "View and manage your customer base" },
  { href: "/customers/new", icon: UserPlus, label: "New Customer",  desc: "Add a new customer to your account" },
]

export default function CustomersHubPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHeader crumbs={[{ label: "Invoices", href: "/invoices" }]} title="Customers" />

      <main className="max-w-5xl mx-auto px-4 py-8">
        <div className="mb-6">
          <h2 className="text-xl font-bold tracking-tight" style={{ color: DARK }}>Customers</h2>
