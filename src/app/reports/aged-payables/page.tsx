...
export default function AgedPayablesPage() {
  ...
  const handleExportCSV = () => {
    ...
    const csvRows = [
      ["Bill #", "Vendor", "Date", "Due Date", "Total", "Balance", "Current", "0-30 Days", "31-60 Days", "61-90 Days", "90+ Days", "Days Overdue"],
    ...
    a.href = url
    a.download = `aged-payables-${debouncedAsOfDate}.csv`
    a.click()
  ...
  return (
    <div className="min-h-screen bg-background">
      <PageHeader crumbs={[{ label: "Reports", href: "/reports" }]} title="Aged Payables" />
          ...
          {isLoading ? (
            <Card>
              <CardContent className="py-12 text-center">
                ...
                <p className="mt-4 text-muted-foreground">Loading aged payables...</p>
              </CardContent>
            </Card>
          ) : agedData ? (
            <>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    {agedData.pagination.total} bill{agedData.pagination.total !== 1 ? 's' : ''} outstanding
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      ...
                      <tbody>
                        {agedData.items.map((item) => (
                          <tr key={item.billId} className="border-b hover:bg-muted/50">
                            <td className="p-2 font-mono text-sm">{item.billNumber}</td>
            ...
            <Card>
              <CardContent className="py-12 text-center">
                ...
                <p className="text-muted-foreground">
                  Select a date to view aged payables
                </p>
              </CardContent>
            </Card>
          )}
