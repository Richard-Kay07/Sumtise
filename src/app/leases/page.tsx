...
export default function LeasesHubPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHeader crumbs={[{ label: "Dashboard", href: "/" }]} title="Leases" />

      <main className="max-w-5xl mx-auto px-4 py-8">
        <div className="mb-6">
          <h2 className="text-xl font-bold tracking-tight" style={{ color: DARK }}>Leases</h2>
          <p className="text-sm text-gray-500 mt-1">IFRS 16 lease accounting and management</p>
        </div>
