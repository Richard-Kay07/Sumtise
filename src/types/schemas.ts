...
export const chartOfAccountSchema = z.object({
  ...
  grantCode: z.string().nullable().optional(),
  costCentreCode: z.string().nullable().optional(),
  departmentCode: z.string().nullable().optional(),
  fundCode: z.string().nullable().optional(),
  analysisCode1: z.string().nullable().optional(),
  analysisCode2: z.string().nullable().optional(),
  analysisCode3: z.string().nullable().optional(),
...
export const createChartOfAccountSchema = z.object({
  ...
  analysisCode1: z.string().optional(),
  analysisCode2: z.string().optional(),
  analysisCode3: z.string().optional(),
  isControlAccount: z.boolean().optional(),
})
